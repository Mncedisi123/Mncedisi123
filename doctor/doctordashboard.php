...
<div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $res=mysqli_query($con,"SELECT count(*) as total1,sum(a.status='attended') as total2,sum(a.status='notAttended') as total  
                                                    from appointment a");
                                  if (!$res) {
                                    printf("Error: %s\n", mysqli_error($con));
                                    exit();
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="diagnosis_Notes" disabled></th>
