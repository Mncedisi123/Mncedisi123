...
$res=mysqli_query($con,"SELECT * FROM Doctor WHERE ReceptionistId=".$usersession);
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($Receptionistschedule=mysqli_fetch_array($result)) {
                                ...
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $Receptionistschedule['scheduleId'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['scheduleDate'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['scheduleDay'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['startTime'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['endTime'] . "</td>";
                                    echo "<td>" . $Receptionistschedule['bookAvail'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$Receptionistschedule['scheduleId']."' class='delete'><span class='fa fa-trash' aria-hidden='true'></span></a>
                            </td>";
